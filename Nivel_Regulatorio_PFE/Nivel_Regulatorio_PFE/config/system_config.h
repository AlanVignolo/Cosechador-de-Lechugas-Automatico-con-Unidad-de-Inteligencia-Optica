...
// ========== TIMEOUTS Y DELAYS ==========
#define MOVEMENT_TIMEOUT_MS     30000   // 30 segundos máx por movimiento
#define GRIPPER_CLOSE_TIME_MS   500     // Tiempo para cerrar gripper
