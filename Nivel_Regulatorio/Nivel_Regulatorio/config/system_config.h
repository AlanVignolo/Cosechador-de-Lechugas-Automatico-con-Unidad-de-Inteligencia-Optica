...
#define SERVO1_MIN_ANGLE    10      // Ángulo mínimo servo 1
#define SERVO1_MAX_ANGLE    160     // Ángulo máximo servo 1
#define SERVO2_MIN_ANGLE    10      // Ángulo mínimo servo 2
#define SERVO2_MAX_ANGLE    160     // Ángulo máximo servo 2
