...
\end{figure}
Al activarse los motores del robot serie se genera una fuerza F1 como la que se muestra en la Figura \ref{fig:esfuerzo_lateral}. Dicha fuerza genera que toda la estructura vertical se mueva hacia atras.
\begin{figure}[H]
        \centering
...
\end{figure}
Para eliminar ese movimiento se coloca un perfil como el de la Figura \ref{fig:barra_lateral}, en conjunto con sus rodamientos (Figura \ref{fig:sbr20uu}) acoplados al soporte superior. De esta manera se genera una fuerza semejante a F1 pero en sentido contrario.
\begin{figure}[H]
    \centering
    \begin{subfigure}{0.35\textwidth}
        \centering
...
\begin{enumerate}
    ...
    \item \textbf{Fuerza total requerida}
    \begin{equation}
...
\textbf{Torque requerido en el motor}\\
\noindent
...
\noindent
Se selecciona un motor paso a paso NEMA 17, alimentado a 24V y 1.8A. Analizando la curva dinámica torque-velocidad (Figura~\ref{fig:Curva_din_nema17}), se verifica que para la velocidad máxima de operación de 250\,mm/s (187.5\,rpm), el torque disponible supera ampliamente el requerimiento calculado de 0.1\,Nm, garantizando un margen de seguridad adecuado para la operación continua del sistema.

\textbf{Resolución de posicionamiento}\\
\noindent
Con la configuración de polea de 40 dientes (80mm/rev) y microstepping de 1/8 paso (1600 pasos/revolución), el sistema alcanza una resolución de 0.05mm/paso, equivalente a 20 pasos/mm.

\textbf{Velocidad máxima del sistema}\\
\noindent
La velocidad lineal máxima de 250mm/s corresponde a una velocidad angular de 187.5 RPM, operando en la zona de torque máximo del motor. 
\begin{figure}[H]
    \centering
