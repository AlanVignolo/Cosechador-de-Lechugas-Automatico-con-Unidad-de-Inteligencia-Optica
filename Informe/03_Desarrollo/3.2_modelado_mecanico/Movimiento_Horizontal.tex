...
Como complemento, se seleccionan dos carros lineales estándar de 100\,mm de ancho, cada uno equipado con 4 ruedas tipo DELRIN (figura \ref{fig:carro_perfilvslot}) que se desplazan sobre el perfil V-Slot (figura \ref{fig:vslot_40x80}).
\begin{figure}[H]
    \centering
...
\end{figure}
Al activarse los motores del robot serie se genera una fuerza F1 como la que se muestra en la figura \ref{fig:esfuerzo_lateral}. Dicha fuerza genera que toda la estructura vertical se mueva hacia atrás.
\begin{figure}[H]
        \centering
...
\textbf{Distribución de cargas en el sistema}\\
\noindent
...
\textbf{Selección polea y correa}\\
\noindent
...
\textbf{Cálculo del torque motor}\\
...
Se selecciona un motor paso a paso NEMA 17, alimentado a 24V y 1.8A. Analizando la curva dinámica torque-velocidad (Figura~\ref{fig:Curva_din_nema34}), se verifica que para la velocidad máxima de operación de 250\,mm/s (187.5\,rpm), el torque disponible supera ampliamente el requerimiento calculado de 0.1\,Nm, garantizando un margen de seguridad adecuado para la operación continua del sistema. 
\begin{figure}[H]
    \centering
