En esta sección se muestra el modelado 3D de los soportes y se realiza el análisis de esfuerzos y deformaciones sobre el soporte superior que es el que recibe la mayor carga.
