...
\textbf{Selección del diámetro}\\
\noindent
Tras evaluar diferentes diámetros comerciales de varillas trapezoidales de acero, se selecciona una varilla TR16$\times$8 (diámetro nominal 16\,mm, paso 8\,mm). En paralelo a la varilla trapezoidal se colocan dos varillas trefiladas de acero de 16 \,mm de diámetro para darle rigidez, soporte y evitar que gire el sistema vertical. Ambas varillas se puede observar en las figuras \ref{fig:v_roscada} y \ref{fig:varilla lisa}.
...
\textbf{Velocidad crítica de rotación}\\
\noindent
