\subsubsection{Procesos Principales del Sistema}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{imagenes/workflow_deteccion.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{imagenes/workflow_cosecha.png}
