...
\date{Fecha de presentación\par XX/XX/2025}
...
\input{03_Desarrollo/3.5_ia_vision/deteccion_cintas}
\input{03_Desarrollo/3.5_ia_vision/calibracion_correccion}

\subsection{Sistema de Clasificación de Cultivos}
\input{03_Desarrollo/3.5_ia_vision/deteccion_clasificacion}
\input{03_Desarrollo/3.5_ia_vision/analisis_estadistico}
