...
Modo de una fase:\\
\noindent
Solo una bobina se energiza a la vez. La secuencia de activación para un motor bipolar de dos fases es la de la siguiente tabla (\ref{tab:sec_excitacion}):
...
Dos bobinas se energizan simultáneamente. La secuencia de activación es la que se muestra en la tabla \ref{tab:excitacion_fullstep}
...
Alterna entre la energización de una y dos fases, duplicando la resolución del motor. La secuencia combina los modos anteriores y se muestra en la tabla \ref{tab:half_step}.\\
...
Torque dinámico (Pull-out Torque):\\
\noindent
...
Driver unipolar:\\
\noindent
Diseñado para motores unipolares (generalmente con 5 o 6 cables). Utiliza transistores simples para conmutar las corrientes. \\
Ventajas:
\begin{itemize}
    \item simplicidad y bajo costo.
\end{itemize}
Desventajas:
\begin{itemize}
    \item menor eficiencia y torque (aproximadamente 70\% del equivalente bipolar).
\end{itemize}

Driver bipolar:\\
\noindent
Se utiliza para motores bipolares (4 cables) ya que requiere puentes H para invertir la polaridad de las corrientes.\\
Las topologías de drivers mas comunes son:
