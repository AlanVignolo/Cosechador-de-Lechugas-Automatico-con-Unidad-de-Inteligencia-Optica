...
\textbf{Elemento estructurante:} En operaciones morfológicas sobre imágenes binarias, el kernel se denomina \textit{elemento estructurante} y define la forma y tamaño del vecindario considerado. Por ejemplo:
\begin{itemize}
